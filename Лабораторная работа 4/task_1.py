...
class Vehicle:
    ...
    def __init__(self, brand: str, year_release: int):
        ...
        :raise ValueError: Если год выпуска не в диапазоне от 1800 до 9999

        Примеры:
        >>> Vehicle = Vehicle("Toyota", 2000)
        Traceback (most recent call last):
        ValueError: Не указан тип автомобиля
        >>> Vehicle.TYPE = "Unknown"
        >>> Vehicle = Vehicle(123, 1995)
        Traceback (most recent call last):
        TypeError: Бренд должен быть строкой
        >>> Vehicle.TYPE = "Unknown"
        >>> Vehicle = Vehicle("Lada", "1995")
        Traceback (most recent call last):
        TypeError: Год выпуска должен быть целым числом
        >>> Vehicle.TYPE = "Unknown"
        >>> Vehicle = Vehicle("Lada", 19959)
        Traceback (most recent call last):
        ValueError: Год выпуска должен быть в диапазоне от 1800 до 9999
        >>> Vehicle.TYPE = "Unknown"
        >>> Vehicle = Vehicle("Lada", 1995)
        """
        ...
        if not (1800 <= year_release <= 9999):
            raise ValueError('Год выпуска должен быть в диапазоне от 1800 до 9999')
    ...
    def maintenance_cost(self, distance: int, maintenance_cost_per_km: int) -> float:
        ...
        >>> Vehicle.maintenance_cost(500, 9)
        4500
        """
    ...
    def __str__(self):
        ...
        >>> Vehicle = Vehicle("Ford", 1990)
        >>> print(Vehicle)
        Unknown автомобиль: Ford 1990 года выпуска
        Возраст автомобиля: 34
        """
...
class Car(Vehicle):
    ...
    >>> print(car)
    Легковой автомобиль: Toyota 2020 года выпуска
    Возраст автомобиля: 4
    """
    TYPE = "Легковой"
...
class Truck(Vehicle):
    ...
    Примеры:
    >>> truck = Truck("MAN", 2001, 100)
    >>> print(truck)
    Грузовой автомобиль: MAN 2001 года выпуска
    Возраст автомобиля: 23
    """
    TYPE = "Грузовой"
